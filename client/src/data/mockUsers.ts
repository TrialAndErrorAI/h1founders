...
export const mockUsers: User[] = [
  ...
  {
    id: 'carlos_freed',
    name: 'freed_founder_42',
    email: 'founder42@anonymous.com',
  ...
  {
    id: 'lisa_unplugged',
    name: 'unplugged_founder_99',
    email: 'anon99@private.com',
  ...
  {
    id: 'david_freed',
    name: 'freed_mind_startup',
    email: 'founder_anon@private.com',
    badge: BadgeLevel.FREED_MIND,
    subLevel: 3,
