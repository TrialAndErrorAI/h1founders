...
// Tech signature patterns for detection (Based on Wappalyzer patterns)
const TECH_SIGNATURES = {
  frameworks: {
    // React - Wappalyzer patterns
    'React': [
      /react\.js/,
      /react-dom\.js/,
      /__react/i,
      /react\.production/,
      /data-react/i,                    // Wappalyzer: HTML attributes
      /_reactRootContainer/i,          // Wappalyzer: DOM property
      /create-react-app/i,             // Wappalyzer: meta description
      /react-[\d.]+.*\.js/,            // Wappalyzer: versioned scripts
    ],
    // Vue - Wappalyzer patterns
    'Vue': [
      /vue\.js/,
      /vue\.runtime/,
      /__vue/i,
      /data-v-[\da-f]{8}/i,           // Wappalyzer: scoped style attributes
      /data-vue-/i,                     // Wappalyzer: Vue directives
      /class="vue-app"/,                // Wappalyzer: common class
      /vue[.-][\d.]+.*\.js/,           // Wappalyzer: versioned scripts
    ],
    // Angular - Wappalyzer patterns
    'Angular': [
      /angular\.js/,
      /angular\.min/,
      /@angular/,
      /ng-version="/i,                  // Wappalyzer: Angular version attribute
      /ng-app=/i,                       // Wappalyzer: AngularJS directive
      /data-ng-/i,                      // Wappalyzer: AngularJS directives
    ],
    'Next.js': [
      /next\.js/,
      /_next\//,
      /next\.config/,
      /__NEXT_DATA__/,                 // Next.js specific global
      /_next\/static\//,               // Next.js build folder
    ],
    'Gatsby': [/gatsby/, /___gatsby/, /gatsby-[\d.]+/],
    'Svelte': [/svelte/, /svelte-[\d.]+/],
    'Nuxt': [/nuxt/, /__NUXT__/, /_nuxt\//],
    // Bootstrap - Enhanced detection
    'Bootstrap': [
      /bootstrap\.js/,
      /bootstrap\.css/,
      /bootstrap\.min/,
      /class="[^"]*\bcontainer\b/,
      /class="[^"]*\brow\b/,
      /class="[^"]*\bcol-/,            // Bootstrap grid classes
      /bootstrap-[\d.]+/,              // Versioned Bootstrap
    ],
    // Tailwind - Wappalyzer patterns
    'Tailwind CSS': [
      /tailwind/,
      /--tw-/,                          // Wappalyzer: CSS variables
      /tailwindcss\.com/,              // Wappalyzer: CDN
      /class="[^"]*\b(flex|grid|p-\d|m-\d|bg-|text-)/,  // Common Tailwind classes
    ],
    'jQuery': [/jquery\.js/, /jquery-[\d.]+/, /\$\(/],
    'Alpine.js': [/alpine/, /x-data=/, /x-show=/, /x-if=/],  // Alpine.js directives
    'Ember.js': [/ember/, /ember-[\d.]+/],
    'Backbone.js': [/backbone/, /backbone-[\d.]+/],
  },
  analytics: {
  ...
  buildTools: {
    ...
    'Turbopack': [/turbopack/],
    'esbuild': [/esbuild/],
    'Framer': [/framer\.com/, /Generated by Framer/i, /framerusercontent\.com/],  // For sites like renovateai.app
  },
}
